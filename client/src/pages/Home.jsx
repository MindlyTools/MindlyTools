...
export default function Home({ user }) {
  ...
  const toolComponents = {
    ...
    pomodoro: <div className={styles.comingSoon}>Pomodoro Timer coming soon!</div>,
    budget: <div className={styles.comingSoon}>Budget Planner coming soon!</div>,
  };

  // Tool data
  const tools = [
    { id: "todolist", title: "Todo List", description: "Manage daily tasks, set priorities, and track progress", icon: "📝" },
    { id: "calculator", title: "Calculator", description: "Perform accurate calculations with an intuitive interface", icon: "🧮" },
    { id: "habits", title: "Habit Tracker", description: "Build consistency and monitor your daily habits easily", icon: "📈" },
    { id: "notes", title: "Notes", description: "Capture and organize your ideas and thoughts instantly", icon: "📒" },
    { id: "pomodoro", title: "Pomodoro Timer", description: "Focus with structured timed work and break sessions", icon: "⏱️" },
    { id: "budget", title: "Budget Planner", description: "Track expenses and manage your personal finances wisely", icon: "💰" },
  ];
